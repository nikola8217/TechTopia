                ...
                <div class="collection-tab-inner">
                    <div class="container">
                        <div class="section-header text-center">
                            <h2 class="section-heading">Latest Arivals</h2>
                        </div>
                        <div class="row">
                                ...
                                <div class="product-card">
                                    <div class="product-card-img">
                                        <a class="hover-switch" href="collection-left-sidebar.html">
                                            <img class="secondary-img" src="asset/img/products/shoe/9.jpg"
                                                alt="product-img">
                                            <img class="primary-img" src="asset/img/products/shoe/1.jpg"
                                                alt="product-img">
                                        </a>
                                    ...
                                    <div class="product-card-details">
                                        ...
                                        <h3 class="product-card-title">
                                            <a href="collection-left-sidebar.html">Macbook Pro</a>
                                        </h3>
                            ...
                            <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                                <div class="product-card">
                                    <div class="product-card-img">
                                        <a class="hover-switch" href="collection-left-sidebar.html">
                                            <img class="secondary-img" src="asset/img/products/shoe/10.jpg"
                                                alt="product-img">
                                            <img class="primary-img" src="asset/img/products/shoe/2.jpg"
                                                alt="product-img">
                                        </a>
                                    ...
                                    <div class="product-card-details">
                                        ...
                                        <h3 class="product-card-title">
                                            <a href="collection-left-sidebar.html">Iphone 14 pro</a>
                                        </h3>
                                        <div class="product-card-price">
                                            <span class="card-price-regular">$1529</span>
                                            <span class="card-price-compare text-decoration-line-through">$1759</span>
                            ...
                            <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                                <div class="product-card">
                                    <div class="product-card-img">
                                        <a class="hover-switch" href="collection-left-sidebar.html">
                                            <img class="secondary-img" src="asset/img/products/shoe/11.jpg"
                                                alt="product-img">
                                            <img class="primary-img" src="asset/img/products/shoe/3.jpg"
                                                alt="product-img">
                                        </a>
                                    ...
                                    <div class="product-card-details">
                                        ...
                                        <h3 class="product-card-title">
                                            <a href="collection-left-sidebar.html">Playstation 5</a>
                                        </h3>
                                        <div class="product-card-price">
                                            <span class="card-price-regular">$1529</span>
                                            <span class="card-price-compare text-decoration-line-through">$1759</span>
                            ...
                            <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                                <div class="product-card">
                                    <div class="product-card-img">
                                        <a class="hover-switch" href="collection-left-sidebar.html">
                                            <img class="secondary-img" src="asset/img/products/shoe/14.jpg"
                                                alt="product-img">
                                            <img class="primary-img" src="asset/img/products/shoe/4.jpg"
                                                alt="product-img">
                                        </a>
                                    ...
                                    <div class="product-card-details">
                                        ...
                                        <h3 class="product-card-title">
                                            <a href="collection-left-sidebar.html">Samsung Galaxy S23</a>
                                        </h3>
                                        <div class="product-card-price">
                                            <span class="card-price-regular">$1529</span>
                                            <span class="card-price-compare text-decoration-line-through">$1759</span>
