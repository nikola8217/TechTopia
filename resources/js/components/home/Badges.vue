                        ...
                        <div class="row justify-content-center trusted-row">
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="trusted-badge bg-trust-1 rounded">
                                    <div class="trusted-icon">
                                        <img class="icon-trusted" src="asset/img/trusted/1.png" alt="icon-1">
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="trusted-badge bg-trust-2 rounded">
                                    <div class="trusted-icon">
                                        <img class="icon-trusted" src="asset/img/trusted/2.png" alt="icon-2">
                                    </div>
                                    <div class="trusted-content">
                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="trusted-badge bg-trust-3 rounded">
                                    <div class="trusted-icon">
                                        <img class="icon-trusted" src="asset/img/trusted/3.png" alt="icon-3">
                                    </div>
                                    <div class="trusted-content">
                                        <h2 class="heading_18 trusted-heading">Discount</h2>
                                        <p class="text_16 trusted-subheading trusted-subheading-2">20% for enough points!</p>
                                    </div>
                                </div>
                            </div>
                        </div>
