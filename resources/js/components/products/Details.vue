            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-12">
                    <div class="product-details ps-lg-4">
                        ...
                        <h2 class="product-title mb-3">{{ name }}  {{ discount > 0 ? (discount + '%') : '' }}</h2>
                        <div class="product-price-wrapper mb-4" v-if="discount > 0">
                            <span class="product-price regular-price">{{ price_with_discount }} RSD</span>
                            <del class="product-price compare-price ms-2">{{ price }}</del>
                        </div>
                        <div class="product-price-wrapper mb-4" v-else>
                            <span class="product-price regular-price">{{ price }} RSD</span>
                        </div>
        ...
        async getProduct() {
            await axios.get(`/api/products/${this.product_id}`)
                .then(response => {
                    ...
                    this.second_img = response.data.product.second_img;
                }).catch(error => {
                    console.log(error);
                });
        },
